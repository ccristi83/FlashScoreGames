...
public class FlashScoreTest {
    ...
    public static void main(String[] args) throws InterruptedException, MessagingException, javax.mail.MessagingException {
        ...
        FlashScoreTest page = new FlashScoreTest();
...
//        page.allGamesList.forEach(game -> System.out.println(game.getResultedScore() + " " + game.getTeamHome() + " " + game.getTeamAway()));
        ...
        //List<PageGameFotball> lista_ord_fotball_score = page.allGamesListFotball;
        ...
        if (lista_ord_goals_min.size()>6) lista_ord_goals_min = lista_ord_goals_min.subList(0,6);
